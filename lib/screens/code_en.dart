...
class MyCodeeng extends StatelessWidget {
  const MyCodeeng({super.key});
                          ...
                          child: CarouselSlider(
                            ...
                            items: [
                              _buildDeveloperSection(
                                context,
                                'Caravaggio Experience (EN)',
                                'assets/tour/caravaggio.png',
                                'Caravaggio',
                                'assets/tour/barcode2.png',
                              ),
                              _buildDeveloperSection(
                                context,
                                'Experience 1 (EN)',
